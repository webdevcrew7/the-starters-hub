            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8 relative z-10">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        {/* Zomato Button */}
                        <a href="" target="_blank" rel="noopener noreferrer" className="h-[52px] w-[138px] bg-[#E23744] hover:bg-[#c12a36] rounded-[14px] hover:scale-105 transition-all flex items-center justify-center shadow-lg shadow-red-500/20 relative overflow-hidden">
