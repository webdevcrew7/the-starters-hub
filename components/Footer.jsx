                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col items-center md:items-end flex-1 shrink-0 gap-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href="http://zoma.to/r/22559719" target="_blank" rel="noopener noreferrer" className="h-[36px] w-[90px] bg-[#E23744] hover:bg-[#c12a36] rounded-lg hover:scale-105 transition-all flex items-center justify-center shadow-md shadow-red-500/20 relative overflow-hidden">
