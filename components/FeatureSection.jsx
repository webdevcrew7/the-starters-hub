                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
                        <div className="order-2 md:order-1">
                            <div className="w-full aspect-square rounded-[3rem] overflow-hidden shadow-2xl shadow-black/50 rotate-3 hover:rotate-0 transition-transform duration-700 relative border-2 border-orange-500/10">
                                <Image
                                    src="/assets/menu/pudinachicken.jpeg"
                                    alt="Pudhina Chicken"
                                    fill
                        ...
                        <div className="order-1 md:order-2 space-y-6">
                            <span className="text-orange-400 font-bold tracking-widest text-sm uppercase">Signature Dish</span>
                            <h2 className="text-4xl md:text-5xl font-bold">
                                <span className="text-white">Refreshing </span><br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-orange-400 to-yellow-400">Pudhina Chicken</span>
                            </h2>
                            <p className="text-gray-400 text-lg leading-relaxed">
                                Our signature Pudhina Chicken — succulent pieces infused with fresh mint, green chillies and aromatic spices, finished with a burst of tangy flavour. Cool, herby, and absolutely addictive.
                            </p>
                            <ul className="space-y-3">
                                {['Farm-fresh Chicken', 'Fresh Mint & Herbs', 'Bold Tangy Finish'].map((item, i) => (
                            ...
                            <div className="pt-2 flex items-center gap-4">
                                ...
                                <a
                                    href="https://wa.me/918885067767?text=Hi!%20I'd%20like%20to%20order%20Pudhina%20Chicken"
                                    target="_blank"
